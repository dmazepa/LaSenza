...
Then The qty "1" and order total "$39.50" are updated to reﬂect the addition.
Then Mini cart slides down.
Then Added items qty "1" and price "$39.50" appears ﬁrst in the list of Mini-Cart items.
