...
Then The quantity "1" and order total "$22.50" are updated to reﬂect the addition.
Then Added ites qty "1" and price "$22.50" appears ﬁrst in the list of Mini-Cart items.
Then Added ites qty "1" and price "$22.50" appears ﬁrst in the Shopping cart.
