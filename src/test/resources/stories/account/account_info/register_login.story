...
Scenario: (MA3) Give to customer detail information about Remember Me functionality.
Given I am on Login page.
When I click on link What This?
Then A light box displays that provides users with an explanation for the form element.

Scenario: (MA4) Allow users create account.
Given I am on Login page.
