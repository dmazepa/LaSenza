...
Scenario: (GSF6) I should see in dependent of my IP special version of site.
...
Scenario:  (GSF7) I should redirects to UK version of site with UK IP.
Given I open home page with UK IP.
Then I should see UK LaSenza site.

Scenario: (GSF9) I can see default version of the site.
Given I am on home page.
Then I sould see default location "ca_en"

Scenario: (GSF8) I can change the version of the site.
Given I am on home page
