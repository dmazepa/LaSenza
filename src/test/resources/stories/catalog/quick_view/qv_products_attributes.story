...
Scenario: Simple products can be available in one size or color (or any other attribute) only.
...
Scenario: Simple products can be available without any additional attributes.
Given I am on QV with simple product.
