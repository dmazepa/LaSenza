...
Then Mini cart slides down.
Then The quantity "1" and order total "$26.50" are updated to reflect the addition.
Then Added items qty "1" and price "$26.50" appears first in the list of Mini-Cart items.
Then Added items qty "1" and price "$26.50" appears first in the Shopping cart.
