...
Then The qty "1" and order total "$7.00" are updated to reﬂect the addition.
Then Mini cart slides down.
Then Added items qty "1" and price "$7.00" appears ﬁrst in the list of Mini-Cart items.
