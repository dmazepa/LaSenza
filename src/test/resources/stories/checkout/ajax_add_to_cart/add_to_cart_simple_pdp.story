...
Then The qty "1" and order total "$26.50" are updated to reﬂect the addition.
Then Mini cart slides down.
Then Added items qty "1" and price "$26.50" appears ﬁrst in the list of Mini-Cart items.
